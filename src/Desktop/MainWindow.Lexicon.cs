...
{
    private static string HotwordStateText(string state)=>state switch{"Sent"=>"已提交","Prepared"=>"待提交","Disabled"=>"词库关闭","Failed"=>"启动失败",_=>"无快照"};
